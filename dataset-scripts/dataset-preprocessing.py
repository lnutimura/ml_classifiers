...
if __name__ == '__main__':
    ...
    '''
    At the beginning, I was fitting the scaler to all the sets involved (training, validation and test dataset).
    ...
    # Now, I'm only fitting it to the training set and taking it as reference to transform the other sets.
    scaler = MinMaxScaler()
    scaler.fit(train_x_res)
    val_x_adjusted = scaler.transform(val_x)
    train_x_res_adjusted = scaler.transform(train_x_res)
